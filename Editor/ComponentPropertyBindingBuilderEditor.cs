...
namespace de.JochenHeckl.Unity.DataBinding.Editor
{
	...
	internal class ComponentPropertyBindingBuilderEditor : UnityEditor.Editor
	{
		public override void OnInspectorGUI()
		{
			...
			var viewBehaviour = componentPropertyBindingBuilder.gameObject.GetComponentInParent<ViewBehaviour>();
		...
		private bool TestForCollapsedView( ViewBehaviour viewBehaviour, ComponentPropertyBindingBuilder componentPropertyBindingBuilder )
		{
			if ( (viewBehaviour == null)
				|| (componentPropertyBindingBuilder == null)
				|| (componentPropertyBindingBuilder.targetComponent == null ))
			{
				return false;
			}
